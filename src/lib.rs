...
#[derive(Debug)]
pub struct CryptoNodeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoNodeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoNode processing");
    
    let mut processor = CryptoNodeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoNodeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoNodeProcessor::new(false);
